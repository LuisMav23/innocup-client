...
<script>
  ...
  <style>
    ...
    .logo {
        margin-right: 2rem; /* Adjust spacing between logo and form */
    }
    </style>

<div class="min-h-screen min-w-screen bg-[#78A2CA] flex items-center justify-center">
  <div class="flex items-center space-x-8">
    ...
    <!-- Form Section -->
    <div class="bg-white rounded-[45px] p-8 flex flex-col shadow-md" style="width: 800px; height: 650px;">
